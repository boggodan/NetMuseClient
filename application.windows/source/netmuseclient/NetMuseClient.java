 ...
 * Beta Version
 * This is not open source software (at least not yet). If you have this source code
 * please do not distribute it. This version is for evaluation purposes only.
 */
...
{
  PApplet.main(new String[] { netmuseclient.NetMuseClient.class.getName() });
}
